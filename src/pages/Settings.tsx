...
import { Settings as SettingsIcon, User, Lock, Trash2, Loader2, Save } from 'lucide-react';
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 max-w-2xl mx-auto">
      ...
      <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-text-muted">
                  {localStorage.getItem('axiom_solves_count') || '0'} / 5
                </span>
              </div>
              <div className="w-full h-2 bg-elevated rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min((parseInt(localStorage.getItem('axiom_solves_count') || '0') / 5) * 100, 100)}%`
                  }}
                />
              </div>
            </div>
            <p className="text-xs text-text-muted">
              Upgrade to <span className="text-accent-primary font-bold">Axiom Plus</span> for 100 solves/month.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bento-card border-red-500/20 bg-red-500/5"
        >
          ...
          {!showDeleteConfirm ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                >
                  {loadingDelete ? <Loader2 size={16} className="animate-spin" /> : null}
                  Yes, Delete
                </button>
              </div>
            </div>
